...
namespace abahaBravo.Service
{
...

    {
        ...
        private void Crawl()
        {
            ...
            string hour = DateTime.Now.ToString("yyyy-MM-dd H");
            ...
            string param = $"?format=json&fromPurchaseDate={today} 00:00:00&toPurchaseDate={today} 23:59:00&pageSize=100";
            string paramCustomer = $"?lastModifiedFrom={today}&orderBy=modifiedDate&orderDirection=desc";


            // add customer
            string customer = ApiService.Get(URL_API + CUSTOMER + paramCustomer, TOKEN);
